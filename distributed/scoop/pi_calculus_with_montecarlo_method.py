'''
Distributes concurrent tasks (called Futures) on heterogeneous computational nodes

Its architecture is based in the ZMQ package

The main application of SCOOP resides in scientific computing that requires the execution of many distributed tasks using all the computational resources available

Futures are created in worker elements instead of central node
'''
